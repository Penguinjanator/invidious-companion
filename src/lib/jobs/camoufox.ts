    ...
    createGeneration(
        ...
        return this.enqueue(async () => {
            ...
            try {
                ...
                // Mint the PO token from an authenticated session when one is
                // available (e.g. OAuth). Google trusts tokens generated by a
                // logged-in session more than anonymous ones.
                const bootstrapClient = authenticatedClient ??
...
export function createCamoufoxPoTokenGeneration(
    ...
    return runtime.createGeneration(fetchImpl, cookies, authenticatedClient);
}
